...
const { registerUser, loginUser, getUserById ,updateUser,changePassword,getAllUser,forgotPassword,removeUser,addOrganizationUser,checkOrganization } = require('../controllers/userController')
